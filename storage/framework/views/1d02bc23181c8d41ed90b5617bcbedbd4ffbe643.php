<?php if($paginator->hasPages()): ?>
    <nav role="navigation" aria-label="<?php echo e(__('Pagination Navigation')); ?>" class="flex items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between mt-10">
            <div>
...
<?php endif; ?>
<?php /**PATH /home/moto/Documents/htdocs/treaning/resources/views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>